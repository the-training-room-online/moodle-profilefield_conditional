...
Feature: Automatically unset hidden fields
  ...
  Scenario: Successfully unset hidden fields for single conditional field
    ...
    And I set the field "profile_field_masterfield" to "Bananas"
    ...
    When I click on "Edit profile" "link" in the "region-main" "region"
    And I expand all fieldsets
    And I set the field "profile_field_masterfield" to "Cherries"
    And I set the field "profile_field_dependentmenu" to "Drills"
    And I start watching to see if a new page loads
    And I click on "Update profile" "button"
    And a new page should have loaded since I started watching
    And I run all adhoc tasks
    ...
    When I click on "Edit profile" "link" in the "region-main" "region"
    And I expand all fieldsets
    And I set the field "profile_field_masterfield" to "Dates"
    And I start watching to see if a new page loads
    And I click on "Update profile" "button"
    And a new page should have loaded since I started watching
    And I run all adhoc tasks
